# Sextant Tutorial 2: Understanding YAML, Lua, and Adding Mortality
...
**This is the most important rule for Sextant!** The column names you use in your Lua scripts must exactly match the column names in your CSV file.
...
**Why does this matter?** Sextant loads your CSV and creates a data structure with the exact column names from your CSV. If you use `Alive` but your CSV has `alive`, Sextant won't find the column.
...
| `type: "lua_model"` | Tells Sextant it's a Lua script | "This is a Lua model" |
...
**Why include `area_id`?**
1. It allows you to analyze results by area
2. It's good practice for when you move to larger populations
3. It prepares your data for future expansion
...
```bash
./sextant config_aging_mortality.yaml
```
